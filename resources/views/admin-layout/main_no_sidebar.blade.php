...
<head>
    {{-- <script src="{{ url('assets_admin/js/color-modes.js') }}"></script> --}}
    <meta charset="utf-8">
    ...
    <link href="{{ url('assets_admin/css/bootstrap_bs5.min.css') }}" rel="stylesheet">
    <link href="{{ url('assets_admin/css/absence_bs5.css') }}" rel="stylesheet">
...
<body>
    ...
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                ...
                <!-- <img class="" src="{{ url('assets_admin/img/logo_gpib.jpeg') }}" alt="" width="50" height="50"> -->

                <span class="fs-4">Absensi</span>
            </a>

            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#">List Absensi</a>
                <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="#">List Birthday</a>
            </nav>
        </div>
    ...
    <footer class="pt-4 mt-2 my-md-5 pt-md-5 border-top">
        <div class="row">
            <div class="col-12 col-md">
                <!-- <img class="mb-2" src="{{ url('assets_admin/img/logo_gpib.jpeg') }}" alt="" width="24" height="19"> -->
                <small class="d-block mb-3 text-body-secondary">&copy; 2023<?= (date('Y') > 2023 ? ' - ' . date('Y') : '') ?> | GPIB Sangkakala Jakarta Barat</small>
            </div>
