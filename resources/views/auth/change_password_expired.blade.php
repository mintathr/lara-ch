...
<head>
    ...
    <title>DB | Change Password</title>
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Anda diarahkan ke halaman Change Password, dikarenakan
                    <br> - password sudah melebihi 30 hari 
                    <br> - password masih default.</p>
                @if (session('error'))
